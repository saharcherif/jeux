...
export function FormationCreate() {
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Remplissez tous les champs pour créer une nouvelle formation</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pb-20">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          ...
          <div className="space-y-6">
                  ...
                  {module.topics.map((topic, topicIndex) => (
                    <div key={topicIndex} className="flex gap-2">
                      <input
                        ...
                        placeholder={`Sujet ${topicIndex + 1}`}
                      />
                      <button
                        type="button"
            ...
            {modules.length === 0 && (
              <p className="text-center text-gray-500 italic">Aucun module ajouté pour le moment.</p>
            )}
          </div>
        </div>

        {/* Summary Program (Legacy support) */}
        <div className="bg-white rounded-2xl border border-gray-200 p-8">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-pink-500 focus:outline-none"
            placeholder="Résumé global du programme ou prérequis..."
          />
        </div>
